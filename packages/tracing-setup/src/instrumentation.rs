...
pub struct Instrumentation {
    ...
    #[clap(long = "log-directive", global = true, env = "QCDN_LOG_DIRECTIVES", value_delimiter = ',', num_args = 0..)]
...
impl Instrumentation {
    ...
    pub(crate) fn filter_layer(&self, packages: &[&str]) -> color_eyre::Result<EnvFilter> {
